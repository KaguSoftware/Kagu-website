        ...
        <>
            ...
            >
                <div className="w-full max-w-(--container-max) mx-auto">
                    ...
                    >
                        A small studio
                        {studio.location ? ` in ${studio.location}` : ""},
                        building customer surfaces and operator-facing admins
                        against the same database — and staying close enough to
                        every project that the handover actually holds.
                    </p>
                </div>
            </section>
                ...
                <div className="w-full max-w-(--container-max) mx-auto">
                    ...
                    >
                        <div className="md:col-span-7">
                            ...
                            >
                                We work in hospitality and operator-facing
                                software, verticals where the test of a system
                                is whether the team uses it on Friday night, not
                                whether it photographs well on Monday morning.
                            </p>
                            <p
                                style={{
                                    fontSize: "var(--type-md)",
                            ...
                            >
                                We build a customer-facing surface and an
                                operator-facing admin against the same database.
                                Production goes live in weeks, not quarters. The
                                handover is the moment we stop being needed, and
                        ...
                        <aside className="md:col-span-4 md:col-start-9">
                            ...
                            >
                                ...
                                <Fact label="Languages">
                                    Turkish · English · Arabic · Persian ·
                                    Russian
                                </Fact>
                            </dl>
                        </aside>
            ...
            >
              ...
              answer it on its own (liftable into AI Overviews). */}
                    ...
                    >
                        Kagu works by listening to what a boutique operator is
                        trying to make easier, mapping the smallest system that
                        solves it, and shipping it to production in weeks. The
                        principles below are how that plays out day to day.
                    </p>
            ...
            >
                <div className="w-full max-w-(--container-max) mx-auto">
                    ...
                    >
                        Tell us about the shift you&apos;re trying to make
                        easier.
                    </p>
                    <Link
                        href="/contact"
